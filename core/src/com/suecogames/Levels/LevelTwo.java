...
public class LevelTwo extends InputAdapter implements Screen {
    ...
    public LevelTwo(final MainGame game){
    ...
    public void show() {
        ...
        //comportamiento
        steeringAgent = new SteeringAgent(playerEntity1.getBody(),playerEntity1.RADIUS,400000);
            ...
            if(firstContact){
                if(agent.getBody().getPosition().y < 0){
                    if(projectilePlayer1.getBody().getPosition().y < -15 || projectilePlayer1.getBody().getPosition().y > 15){
                        ...
                        projectilePlayer1.getBody().setLinearVelocity(0,-25);
                        if(game.SOUND)
                ...
                if(fixtureA.getBody().getUserData() != null && fixtureB.getBody().getUserData() != null){
                    ...
                    || fixtureA.getBody().getUserData().equals("IA") && fixtureB.getBody().getUserData().equals("puck")){
                        ...
                        if(agent.getBody().getPosition().y > 13.4){
                            ...
                            if(agent.getBody().getPosition().x > 8.4){
