...
public class LevelOneHalf extends InputAdapter implements Screen {
    ...
    public LevelOneHalf(final MainGame game){
    ...
    private void resetearPosiciones(boolean jugador) {
        ...
        //balas
        projectilePlayer2.getBody().setTransform(5,-17,0);
        projectilePlayer1.getBody().setTransform(5,17,0);
        projectilePlayer12.getBody().setTransform(5,17,0);
    ...
    public void show() {
        ...
        //comportamiento
        steeringAgent = new SteeringAgent(playerEntity1.getBody(),playerEntity1.RADIUS,50);
