...
public class LevelFour extends InputAdapter implements Screen {
    ...
    public LevelFour(final MainGame game){
    ...
    public void show() {
        ...
        //comportamiento
        steeringAgent = new SteeringAgent(playerEntity1.getBody(),playerEntity1.RADIUS,800000);
