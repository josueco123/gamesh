...
public class LevelFive extends InputAdapter implements Screen {
    ...
    public LevelFive(final MainGame game){
    ...
    public void show() {
        ...
        //comportamiento
        steeringAgent = new SteeringAgent(playerEntity1.getBody(),playerEntity1.RADIUS,1000000);
            ...
            if(firstContact){
                if(agent.getBody().getPosition().y < 0){
                    if(projectilePlayer1.getBody().getPosition().y < -16 || projectilePlayer1.getBody().getPosition().y > 16){
                        ...
                        projectilePlayer1.getBody().setLinearVelocity(0,-40);
                        if(game.SOUND)
        ...
        switch (game.challengeLEVEL) {
            case 48:
                if (puntuacionJugador1 == 7) {
                    ...
                    game.setScreen(endGameScreen);
                } else if (puntuacionJugador2 == 12) {
                    endGameScreen = new EndGameScreen(game, false, result);
                    game.setScreen(endGameScreen);
                }
                break;
            case 49:
                if (puntuacionJugador1 == 9) {
                    game.challengeLEVEL++;
                    endGameScreen = new EndGameScreen(game, true, result);
                    game.setScreen(endGameScreen);
                } else if (puntuacionJugador2 == 15) {
                    endGameScreen = new EndGameScreen(game, false, result);
                    game.setScreen(endGameScreen);
                }
                break;
